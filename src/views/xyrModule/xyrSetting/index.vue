        ...
        <div>
          <el-col :span="8" class="item-card">
              <el-card shadow="hover">
                ...
                <el-button type="text" class="button" @click="handleEdit(xyr)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
        </div>
...
<script>
import { createXyrStation, getXyrStation, updateStation } from '@/api/teachingAndRes/xyrSetting'
    ...
    methods: {
       ...
       async handleEdit(value) {
        ...
        handleStationAddSubmit() {
            ...
            createXyrStation(this.stationSubmit).then(res => {
                console.log('res :>> ', res);
                if(res.code == 200) {
                    this.$message({
                        type:'success',
