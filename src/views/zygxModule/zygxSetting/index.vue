        ...
        <div>
          <el-col :span="8" class="item-card">
              <el-card shadow="hover">
                ...
                <el-button type="text" class="button" @click="handleEdit(zyjs)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
          <el-col :span="8" class="item-card">
              <el-card shadow="hover">
                {{jingsai.title}}
                <div class="bottom clearfix">
                <el-button type="text" class="button" @click="handleEdit(jingsai)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
        </div>
...
<script>
import { createZygxStation, getZygxStation, updateStation } from '@/api/teachingAndRes/zygxSetting'
    ...
    methods: {
       ...
       async handleEdit(value) {
        ...
        handleStationAddSubmit() {
            ...
            createZygxStation(this.stationSubmit).then(res => {
                console.log('res :>> ', res);
                if(res.code == 200) {
                    this.$message({
                        type:'success',
