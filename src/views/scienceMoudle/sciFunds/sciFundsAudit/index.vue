      ...
      <el-form ref="form" :inline="true" :model="form" class="demo-form-inline">
        ...
        <el-collapse>
          ...
          <el-collapse-item title="科研经费数据">
              ...
              <div class="collapse-item"><strong>个人逐项计分：</strong>{{form.scienceMoudle ? (form.scienceMoudle.sciFunds ? (30 * form.scienceMoudle.sciFunds.fScienceFunds / form.scienceMoudle.sciFunds.ratedFunds).toFixed(2) : 0) : 0}}</div>
          </el-collapse-item>
