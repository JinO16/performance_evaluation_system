<template>
  <div class="app-container">
    <el-table v-loading="listLoading" :data="list" highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="科研立项总分" width="150px">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    handleAudit(value) {
      console.log('value :>> ', value);
      if (value.scienceMoudle.sciProjects.status == '待审核') {
    ...
    //审核提交接口调用
    handleSubmit(params) {
      this.form.scienceMoudle.sciProjects.auditRecord.unshift(params);
      this.form.scienceMoudle.sciProjects.status = params.auditStatus;
