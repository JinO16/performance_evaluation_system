        ...
        <div>
          <el-col :span="8" class="item-card">
              <el-card shadow="hover">
                ...
                <el-button type="text" class="button" @click="handleEdit(workLoad)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
          <el-col :span="8" class="item-card">
            <el-card shadow="hover">
                {{teachResChild.title}}
                <div class="bottom clearfix">
                <el-button type="text" class="button" @click="handleEdit(teachResChild)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
          <el-col :span="8" class="item-card">
            <el-card shadow="hover">
                {{teaProAndOther.title}}
                <div class="bottom clearfix">
                <el-button type="text" class="button" @click="handleEdit(teaProAndOther)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
        </div>
...
<script>
import { createTeaStation, getTeaStation, updateStation } from '@/api/teachingAndRes/teachSetting'
