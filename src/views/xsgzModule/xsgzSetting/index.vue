        ...
        <div>
          <el-col :span="8" class="item-card">
              <el-card shadow="hover">
                ...
                <el-button type="text" class="button" @click="handleEdit(zhuanxiang)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
          <el-col :span="8" class="item-card">
              <el-card shadow="hover">
                {{huojiang.title}}
                <div class="bottom clearfix">
                <el-button type="text" class="button" @click="handleEdit(huojiang)">编辑</el-button>
                </div>
              </el-card>  
          </el-col>
        </div>
...
<script>
import { createXsgzStation, getXsgzStation, updateStation } from '@/api/teachingAndRes/xsgzSetting'
    ...
    methods: {
       ...
       async handleEdit(value) {
        ...
        handleStationAddSubmit() {
            ...
            createXsgzStation(this.stationSubmit).then(res => {
                console.log('res :>> ', res);
                if(res.code == 200) {
                    this.$message({
                        type:'success',
